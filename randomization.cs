...
public class NewNewScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        UnityEngine.Debug.Log("instr_num before start " + instruction_number);
        display.Generate();
        ...
        UnityEngine.Debug.Log("instr_num in start: " + instruction_number);
    ...
    public void PreviousStep()
    {
        ...
        {
            curr_instr_num = curr_instr_num - 1;
            UnityEngine.Debug.Log("current_inst: " + curr_instr_num);

            InstructionAndPicture instructionChosen = new InstructionAndPicture();
            instructionChosen = (InstructionAndPicture)previousInstructions[curr_instr_num - 2];
...
public class DisplayRandomInstructions
{
    ...
    ArrayList randomCategories = new ArrayList();
    ...
    ArrayList carabiner = new ArrayList();
    ...
    private void CreateRandomCategories()
    {
        int numFlip = 10, numPush = 25, numPlug = 2, numKnob = 5, numCarabiner = 4;
        for (int i = 0; i < numFlip; i++) {
            randomCategories.Add(0);
        }
        for (int i = 0; i < numPush; i++) {
            randomCategories.Add(1);
        }
        for (int i = 0; i < numPlug; i++) {
            randomCategories.Add(2);
        }
        for (int i = 0; i < numKnob; i++) {
            randomCategories.Add(3);
        }
        for (int i = 0; i < numCarabiner; i++) {
            randomCategories.Add(4);
        }
    }
    ...
    {
        corners.Add("top right corner.");
        corners.Add("top left corner.");
        corners.Add("bottom right corner.");
        corners.Add("bottom left corner.");
    }
    ...
    private void createInstructionDictionary()
    {
        ...
        instruct_dict.Add("Carabiner", carabiner);
